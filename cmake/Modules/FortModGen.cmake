function(FortModGen)
  ...
  if(NOT EXISTS ${OPTS_MOD_DESCRIPTOR_FILE})
    message(FATAL_ERROR "FortModGen passed MOD_DESCRIPTOR_FILE: \"${OPTS_MOD_DESCRIPTOR_FILE}\" to non-existant file.")
  endif()
...
function(FortModName)
  ...
  if(NOT EXISTS ${OPTS_MOD_DESCRIPTOR_FILE})
    message(FATAL_ERROR "FortModName passed MOD_DESCRIPTOR_FILE: \"${OPTS_MOD_DESCRIPTOR_FILE}\" to non-existant file.")
  endif()
